...
class Grafo{
	...
	public:
		...
		Aresta *addAresta(int id, int origem, int destino, float peso1, float peso2, float peso3, float peso4);
		Aresta *addArestaDirecionada(int id, int origem, int destino);
